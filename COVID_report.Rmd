...
## 주간 COVID-19 $R_t$ 분석 (`r format(Sys.time(), '%B %d, %Y')`)
<!-- ## 개요 -->
...
## $R_t$ 추정값, 일별 확진자 
- 일별확진자 (자료 = 빨간점)
```{r echo=FALSE, out.width="340px", out.height="270px", fig.align='center'}
...
df <- cbind(Rt_quantile, dat[, .(date)])
df2 <- df[, c("date", "2.5%", "25%", "50%", "75%", "97.5%")]

fwrite(df2, paste0("outputs/Rt_estimates", tstamp, ".csv"))
